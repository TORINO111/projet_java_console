...
public class ArticleRepositoryJdbcPostgreImpl extends RepositoryDbPostgreImpl<Article> implements ArticleRepository {
    ...
    private static final String SELECT_QUERY = "SELECT articles.id AS article_id, articles.libelle AS article_libelle, articles.qtestock AS article_qte_stock, articles.prixunitaire As article_prix_unitaire, articles.created_at AS article_created_at, articles.updated_at AS article_updated_at FROM articles";
    ...
    public Article convertToObject(ResultSet resultSet) {
        try {
            ...
            return new Article(articleId, libelle, prixUnitaire, qteStock,created_at, updated_at);
        } catch (SQLException e) {
